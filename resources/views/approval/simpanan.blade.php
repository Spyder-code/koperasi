    ...
    <div class="col-12">
        <div class="page-title-box">
            <div class="float-left">
                <h4 class="page-title">Approval Request Simpanan </h4>
                <small class="text-danger">Periode : {{ periode()->name }}</small>
            </div>
            <div class="float-right">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Transaksi</a></li>
                <li class="breadcrumb-item active"><a href="{{route('laporan.cash-bank')}}">Approval Request Simpanan</a></li>
                </ol>
            ...
            <table id="datatable-buttons1" class="table table-striped table-bordered display nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->keterangan }}</td>
                        <td>
                            <form action="{{ route('approval.update',$item) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="d-flex">
                                    <button type="submit" name="status" value="1" onclick="return confirm('are you sure?')" class="btn btn-success">Approve</button>
