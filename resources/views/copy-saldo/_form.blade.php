<div>
    <section>
            <div class="form-group clearfix">
                ...
                <div class="">
                    {!! Form::select('from_periode_id', [''=>'']+App\Models\Periode::pluck('name','id')->all(), null, ['class' => $errors->has('from_periode_id') ? 'form-control is-invalid' : 'form-control']) !!}
            ...
            <div class="form-group clearfix">
                ...
                <div class="">
                    {!! Form::select('to_periode_id', [''=>'']+App\Models\Periode::pluck('name','id')->all(), null, ['class' => $errors->has('to_periode_id') ? 'form-control is-invalid' : 'form-control']) !!}
                    @error('to_periode_id')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
