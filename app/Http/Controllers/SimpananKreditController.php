...
class SimpananKreditController extends Controller
{
    ...
    {
        //
        if (\Auth::user()->isAbleTo('manage-kredit-simpanan')) {
            # code...
            if ($request->ajax()) {
    ...
    {
        //
        if (\Auth::user()->isAbleTo('create-kredit-simpanan')) {
            # code...
    ...
    {
        //
        if (\Auth::user()->isAbleTo('edit-kredit-simpanan')) {
            # code...
    ...
    {
        if (\Auth::user()->isAbleTo('upload-kredit-simpanan')) {
            # code...
