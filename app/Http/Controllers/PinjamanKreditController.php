...
class PinjamanKreditController extends Controller
{
    ...
    {
        //
        if (\Auth::user()->isAbleTo('manage-kredit-pinjaman')) {
            # code...
            if ($request->ajax()) {
                ...
                return DataTables::of($transaksiHarian)
                    ...
                    ->editColumn('jenis_transaksi', function ($transaksiHarian) {
                        return '<span class="badge badge-info badge-pill">Ambil Pinjaman</span>';
                    })
    ...
    {
        //
        if (\Auth::user()->isAbleTo('edit-kredit-pinjaman')) {
            # code...
    ...
    {
        if (\Auth::user()->isAbleTo('upload-kredit-pinjaman')) {
            # code...
